...
//we want to pass down onTodoClick method(prop), and want onTodoClick to dispatch a TOGGLE_TODO action
...
//create the VisibleTodoList "component" by calling connect()
